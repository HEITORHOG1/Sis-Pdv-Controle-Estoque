namespace Sis_Pdv_Controle_Estoque_Form.Paginas.Categoria
{
    partial class AltCategoria
    {
        ...
        private void InitializeComponent()
        {
            ...
            // pnHeader
            // 
            pnHeader.BackColor = Color.FromArgb(230, 126, 34);
            ...
            lblTitulo.Text = "✏️ Alterar Categoria";
            // 
            // btnClose
            // 
            ...
            txtNomeCategoria.Size = new Size(345, 22);
            ...
            lblInstrucoes.Size = new Size(365, 44);
            lblInstrucoes.TabIndex = 2;
            lblInstrucoes.Text = "💡 Modifique o nome da categoria e confirme a alteração.";
            // 
            // LblId
            // 
            LblId.AutoSize = true;
            ...
            Load += AltCategoria_Load;
            KeyDown += AltCategoria_KeyDown;
